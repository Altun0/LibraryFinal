...
public partial class DBKUTUBHANEEntities : DbContext
{
    public DBKUTUBHANEEntities()
        : base("name=DBKUTUBHANEEntities")
    {
    ...
    public virtual DbSet<TBLKATEQORI> TBLKATEQORIs { get; set; }
